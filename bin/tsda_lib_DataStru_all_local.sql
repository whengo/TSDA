...
go
 ...
 if OBJECT_ID('takewiki_k3_md_currency_view_rebuild') is not null
drop proc takewiki_k3_md_currency_view_rebuild
go
create proc takewiki_k3_md_currency_view_rebuild (@FromDB nvarchar(50)='')
as
begin
--@FromDB 用于指定事实表的来源，主要包括来源于
--1） 来源于K3ERP数据库
...
declare @sql_pre nvarchar(max)
declare @sql_run nvarchar(max)
select @sql_pre =N'if object_id('+char(39)+N'takewiki_k3_md_currency_view'+char(39)+N') is not null
drop view  '+N'takewiki_k3_md_currency_view'
---select @sql_pre
exec sp_executesql @sql_pre
if @FromDB = ''
 begin
...
--char(39)是用于取代'的func
select @sql_run = N'create view  '+N'takewiki_k3_md_currency_view'+N'
 as'+space(3)+N'
select fcurrencyID as FItemID,FNumber,FName,FScale,FDeleted   from  '
+@FromDB+N'.dbo.t_currency '

exec sp_executesql @sql_run
end
go

---takewiki_k3_md_currency_view_rebuild ''
--   tsda 'takewiki_k3_md_currency_view'
-- takewiki_k3_md_currency_view_rebuild 'AIS20141027173850'
---takewiki_k3_md_currency_view_rebuild 'AIS20160721134104'
...
if object_id('takewiki_k3_md_customer_view_rebuild') is not null
drop proc takewiki_k3_md_customer_view_rebuild
go
create proc takewiki_k3_md_customer_view_rebuild (@FromDB nvarchar(50)='')
as
begin
declare @sql_pre nvarchar(max)
declare @sql_run nvarchar(max)
select @sql_pre =N'if object_id('+char(39)+N'takewiki_k3_md_customer_view'+char(39)+N') is not null
drop view  '+N'takewiki_k3_md_customer_view'
---select @sql_pre
exec sp_executesql @sql_pre
if @FromDB = ''
 begin
...
--char(39)是用于取代'的func
select @sql_run = N'create view  '+N'takewiki_k3_md_customer_view '+N'
 as'+space(3)+N'
...
left join '+@FromDB+N'.dbo.t_Organization b
on a.FItemID=b.FItemID
 where  a.fitemclassid=1'
...
---takewiki_k3_md_customer_view_rebuild ''
---takewiki_k3_md_customer_view_rebuild 'AIS20160721134104'
...
if OBJECT_ID('takewiki_k3_md_department_view_onlyDetail_rebuild') is not null
drop proc takewiki_k3_md_department_view_onlyDetail_rebuild
go
create proc takewiki_k3_md_department_view_onlyDetail_rebuild
as
begin
--@FromDB 用于指定事实表的来源，主要包括来源于
--1） 来源于K3ERP数据库
...
declare @sql_pre nvarchar(max)
declare @sql_run nvarchar(max)
select @sql_pre =N'if object_id('+char(39)+N'takewiki_k3_md_department_view_onlyDetail'+char(39)+N') is not null
drop view  '+N'takewiki_k3_md_department_view_onlyDetail'
---select @sql_pre
exec sp_executesql @sql_pre

--char(39)是用于取代'的func
select @sql_run = N'create view  '+N'takewiki_k3_md_department_view_onlyDetail '+N'
 as'+space(3)+N'
...
---takewiki_k3_md_department_view_onlyDetail_rebuild
--   tsda 'takewiki_k3_md_department_view_onlyDetail'
if OBJECT_ID('takewiki_k3_md_customer_view_onlyDetail_rebuild') is not null
drop proc takewiki_k3_md_customer_view_onlyDetail_rebuild
go
create proc takewiki_k3_md_customer_view_onlyDetail_rebuild
as
begin
--@FromDB 用于指定事实表的来源，主要包括来源于
--1） 来源于K3ERP数据库
...
declare @sql_pre nvarchar(max)
declare @sql_run nvarchar(max)
select @sql_pre =N'if object_id('+char(39)+N'takewiki_k3_md_customer_view_onlyDetail'+char(39)+N') is not null
drop view  '+N'takewiki_k3_md_customer_view_onlyDetail'
---select @sql_pre
exec sp_executesql @sql_pre

--char(39)是用于取代'的func
select @sql_run = N'create view  '+N'takewiki_k3_md_customer_view_onlyDetail '+N'
 as'+space(3)+N'
select * from takewiki_k3_md_customer_view
where fdetail=1  '
...
---takewiki_k3_md_customer_view_onlyDetail_rebuild
--   tsda 'takewiki_k3_md_customer_view_onlyDetail'
